...
{
        NSMutableDictionary *dict = (NSMutableDictionary *)[self getAssociatedObject:__es_EventsKey];
        if (!dict) {
...
{
        [self setAssociatedObject_nonatomic_retain:events key:__es_EventsKey];
}
