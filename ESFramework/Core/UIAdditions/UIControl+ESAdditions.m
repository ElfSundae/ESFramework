...
{
        NSMutableDictionary *dict = (NSMutableDictionary *)es_objc_getAssociatedObject(self, __es_EventsKey);
        if (!dict) {
...
{
        es_objc_setAssociatedObject(self, __es_EventsKey, events, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
